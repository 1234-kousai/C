            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                >
                  ...
                  >
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-2xl blur-lg opacity-20 group-hover:opacity-30 transition-opacity" />
                    <div className="relative bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl border border-gray-100 dark:border-gray-700 h-full">
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        企業のDX戦略を支援するグローステック・パートナー。AI技術と専門チームで事業成長を加速させます。
                      </p>
                    </div>
                  </motion.div>
                  ...
                  <motion.div 
                    ...
                    transition={{ type: "spring", stiffness: 300 }}
                  >
                    <div className="absolute inset-0 bg-gradient-to-r from-gray-700 to-gray-900 rounded-2xl blur-lg opacity-20 group-hover:opacity-30 transition-opacity" />
                    <div className="relative bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl border border-gray-100 dark:border-gray-700 h-full">
                      <div className="flex items-center gap-3 mb-4">
                        <div className="w-10 h-10 bg-gradient-to-r from-gray-700 to-gray-900 rounded-lg flex items-center justify-center">
                          <Sparkles className="w-5 h-5 text-white" />
                        </div>
                        <h4 className="text-xl font-bold bg-gradient-to-r from-gray-700 to-gray-900 bg-clip-text text-transparent">
                          Noir Producers
                        </h4>
                      </div>
                      <p className="text-gray-600 dark:text-gray-300">
                        夜職業界特化のSNSプロデュースチーム。戦略的なブランディングで新たな価値を創造します。
                      </p>
                    </div>
                  </motion.div>
                </motion.div>
